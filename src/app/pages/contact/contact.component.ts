...
import { Address, User } from 'src/app/interfaces/interface';
...
export class ContactComponent {
	...
	address: Address[] = [
		{ index: 1, title: "Mobile", viewValue: "+91 7030107979" },
		{ index: 2, title: "Email", viewValue: "sales@thekoders.net" },
		{ index: 3, title: "Address", viewValue: "1 Radisson Plz Ste 800, New Rochelle, New York, 10801, United States" },
	];

	displayedColumns: string[] = ['Contact From', ''];
	form!: FormGroup;
